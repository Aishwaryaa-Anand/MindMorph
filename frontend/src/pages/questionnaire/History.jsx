...
export default function QuestionnaireHistory() {
  ...
  const loadHistory = async () => {
    try {
      const data = await questionnaireService.getHistory();
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/80 text-lg">
            Your past personality assessments
          </p>
        </div>
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="glass-card text-center">
                <p className="text-white/70 mb-2">Total Assessments</p>
              ...
              <div className="glass-card text-center">
                <p className="text-white/70 mb-2">Last Taken</p>
                <p className="text-xl font-bold text-white">
                  {new Date(predictions[0].timestamp).toLocaleDateString()}
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              {predictions.map((pred) => (
                <div
                  ...
                  onClick={() => navigate(`/questionnaire/result/${pred._id}`)}
                >
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-xl font-bold text-white">{pred.mbtiType}</p>
                    ...
                    <div className="flex items-center gap-6">
                      <div className="text-right">
                        <p className="text-white/70 text-sm mb-1">Avg Confidence</p>
                        <p className="text-2xl font-bold text-white">
                          {Math.round(
                            Object.values(pred.confidence).reduce((a, b) => a + b, 0) /
                            Object.values(pred.confidence).length * 100
                          )}%
                        </p>
                      </div>
